# Generated by Django 4.0 on 2025-01-10 03:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division', models.ForeignKey(limit_choices_to={'type': '部署'}, on_delete=django.db.models.deletion.CASCADE, related_name='users_in_division', to='main.position')),
                ('position', models.ForeignKey(limit_choices_to={'type': '役職'}, on_delete=django.db.models.deletion.CASCADE, related_name='users_in_position', to='main.position')),
                ('team', models.ForeignKey(limit_choices_to={'type': '課'}, on_delete=django.db.models.deletion.CASCADE, related_name='users_in_team', to='main.position')),
            ],
            options={
